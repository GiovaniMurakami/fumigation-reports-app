...
export function NewReport() {
  ...
  const activityFields = rawActivityFields.filter(field => !shouldHideField(field, sectionName)).map(sanitizeField);
  ...
  async function submit(e) {
    ...
    try {
      ...
      const item = await api.criar({
        ...
        dados: { ...baseFields, ...dados, ...repeatableDados, ...nestDados, ...rodentDados },
        fotos,
      });
